						...
						<div class="shop-desc-container"> 
							...
							<div class="shop-desc <?php echo esc_attr($shoplayout);?>"> 
								<div class="shop_header"> 
									<?php if( isset($aboss_opt['bg_shop']['url']) && $aboss_opt['bg_shop']['url']!=''){ ?>
										<div class="bg-shop"><img src="<?php echo esc_url($aboss_opt['bg_shop']['url'])?>" /></div>
									<?php } ?> 
								</div> 
							</div>
								...
								<?php if ( woocommerce_products_will_display() ) { ?>
									<div class="toolbar">
										<div class="toolbar-inner">
											<div class="view-mode">
												<label><?php esc_html_e('View on', 'aboss');?></label>
												<a href="#" class="grid <?php if($aboss_viewmode=='grid-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'Grid', 'aboss' ); ?>"></a>
												<a href="#" class="list <?php if($aboss_viewmode=='list-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'List', 'aboss' ); ?>"></a>
											</div>
											<?php
												/**
